<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMarker.aspx.cs" Inherits="_Default" %>
...
<div  class="right">
Click the button to add a marker on the map.<br /><br />
    <asp:Button ID="button1" runat="server" OnClick="button1_Click" Text="Add a Marker" /><br/>
</div>
