...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void panTop_Click(object sender, EventArgs e)
    {
        map.Pan(CompassDirection.South, 30);
    }
    protected void panLeft_Click(object sender, EventArgs e)
    {
        map.Pan(CompassDirection.East, 30);
    }
    protected void panRight_Click(object sender, EventArgs e)
    {
        map.Pan(CompassDirection.West, 30);
    }
    protected void panBottom_Click(object sender, EventArgs e)
    {
        map.Pan(CompassDirection.North, 30);
    }
}
